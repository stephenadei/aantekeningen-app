...
# Note: GraphicsMagick and pdf2pic are NOT needed in the app container
# Thumbnails are generated by the standalone process-thumbnails.mjs script
# which runs separately with its own dependencies
